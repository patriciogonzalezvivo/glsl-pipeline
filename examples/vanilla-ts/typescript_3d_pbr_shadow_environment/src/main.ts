import './style.css'
import { WebGLRenderer, PerspectiveCamera, Scene, DirectionalLight, BoxGeometry, SphereGeometry, ConeGeometry, Mesh, PlaneGeometry, Vector3 } from 'three';
...
const shader_frag = resolveLygia(/* glsl */`
            ...
            void main() {
                ...
                mat3 ca = raymarchCamera( CAMERA_POSITION );
                vec3 ray = ca * normalize(vec3(sst, 1.0));
                color.rgb = ENVMAP_FNC(ray, 0.0, 0.0);
